...
| G2 INSTRUMEN | 🔴 **TERKONFIRMASI GAGAL (2026-07-07)** | Validasi stratified n=30 (Wilson 95%): vonis **73.3%** [55.6–85.8], kerugian **80.0%** [62.7–90.5], tuntutan 93.3%, daerah 93.3%, tahun/nama 96.7%. Bug sistematis: (a) uang pengganti/pengembalian tertukar kerugian negara; (b) vonis PN/PT superseded & klausul subsider terambil, pola "menolak tapi memperbaiki" gagal; (c) 2 putusan BEBAS tercatat punya vonis; (d) 1 kasus narkotika lolos ke korpus. Detail: data/golden_set/golden_expansion_30_validated.csv. **Konsekuensi: parser fix + re-ekstraksi + re-analisis WAJIB sebelum submit; angka elasticity akan berubah (kemungkinan naik).** |
